// Configuration - Update this to your Vercel URL
const API_BASE_URL = 'https://your-project.vercel.app'; // Replace with your Vercel URL
        ...
        if (updates.length === 0) {
            updatesContainer.innerHTML = `
                <div class="error-message">
                    ...
                    <p class="error-details">Make sure the server is running</p>
                </div>
            `;
        }
    }
